...
STACK_NAME="finex-dmz-$FINEX_AWS_REGION"
create_aws_stack finex-dmz-ec2.json $STACK_NAME "ParameterKey=KeyName,ParameterValue=$FINEX_AWS_KEY_NAME"
DMZ_EC2_DNS=`get_aws_stack_output $STACK_NAME FinexPublicDnsName`
